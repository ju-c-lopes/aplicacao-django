...
var inputPassOne = document.querySelector("#id_password1");
var inputPassTwo = document.querySelector("#id_password2");
var buttonFinishRegister = document.querySelector("#finalizar-cadastro");
