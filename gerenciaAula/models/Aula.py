...
class Aula(models.Model):
    ...
    cod_hab = models.ForeignKey(
        "Habilidade", models.DO_NOTHING, db_column="cod_hab", blank=True, null=True
    )
    desc_aula = models.TextField(blank=True, null=True)
    user = models.ForeignKey(
        "Usuario", models.DO_NOTHING, db_column="user", blank=True, null=True
    )
    cod_turma = models.ForeignKey(
        "Turma", models.DO_NOTHING, db_column="cod_turma", blank=True, null=True
    )
